  ...
  return (
    <>
      <motion.img
        ...
        src="https://png.pngtree.com/png-vector/20230728/ourmid/pngtree-dj-headphone-clipart-vector-png-image_6862080.png"
        alt=""
        ...
        <div className="self-center">
          ...
          <div className="flex gap-2 align-center flex-wrap md:flex-nowrap">
            ...
            <div className="hidden lg:block w-[480px] self-center">
              <img
                className="rounded-[10%] transform rotate-3 scale-125"
                src={user_info.main.photo}
